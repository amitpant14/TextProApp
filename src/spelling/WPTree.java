...
//        System.out.println("path here 0");
		root = new WPTreeNode(word1, null);
//        System.out.println("path here 1");
//        System.out.println(word1);
		visited.add(word1);
//        System.out.println("path here test1");
		queue.add(root);
//        System.out.println("path here test2");
		while(queue.size()!=0) {
			WPTreeNode curr = queue.remove();
//	        System.out.println("path here 2");
			List<String> related = nw.distanceOne(curr.getWord(), true);
//	        System.out.println("path here 3");
			for (String word : related) {
				if (!visited.contains(word)) {
					visited.add(word);
					curr.addChild(word);
					WPTreeNode child = new WPTreeNode(word, curr);
					queue.add(child);
