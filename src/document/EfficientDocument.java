...
//				System.out.println("It is a word");
				allWords+=1;
				int count = countSyllables(token);
				allSyllables+=count;
			}
			else {
//				System.out.println("It is a sentence");
		...
		if (isWord(tokens.get(count2-1))) {
//			System.out.println(tokens.get(count2-1));
			allSentences+=1;
		}
		numWords = allWords;
		numSentences = allSentences;
		numSyllables = allSyllables;
//		System.out.println("Words = " + Integer.toString(numWords) + " Sentences = " + Integer.toString(numSentences) + " Syllables = " + Integer.toString(numSyllables));
